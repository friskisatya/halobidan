...
<h6 class="title float-right btn-sm btn-primary" onclick="window.location='<?=base_url('C_setup_fasilitas/create_web')?>'"><i class="fas fa-plus"></i>&nbsp Tambah</h6>
                ...
                ?>
                    <tr>
                        ...
                        <button
                            ...
                            <button onclick="window.location='<?=base_url('C_setup_fasilitas/edit_web/').$fas->id_fasilitas?>'"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="window.location='<?=base_url('C_setup_fasilitas/delete_web/').$fas->id_fasilitas?>'">Hapus</button>
      </div>
    </div>
  </div>
</div>
