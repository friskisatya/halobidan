<div class="card-wrapper">
    <div class="card-body">
        ...
        <form action="<?=base_url('C_setup_klinik/post_edit_web/').$id ?>" method="POST">
            <div class="card-body">
                <div class="form-group">
                    <label for="nama_klinik">Nama Klinik</label>
                    <input required type="text" value="<?=$rs_klinik[0]->nama_klinik?>" name="nama_klinik"
                        id="nama_klinik" class="form-control" placeholder="Nama Klinik">
                </div>
                <div class="form-group">
                    ...
                    <Textarea required name="alamat_klinik" id="alamat_klinik" class="form-control" cols="50"
                        rows="20"><?=$rs_klinik[0]->alamat_klinik?></textarea>
                </div>
                <div class="form-group">
                    <label for="inputPhone">Telepon</label>
                    <div class="input-group">
                        <input required type="number" value="<?=$rs_klinik[0]->telp_klinik?>" name="telp_klinik"
                ...
                <div class="form-group">
                    ...
                    <Textarea required name="tentang" id="tentang" class="form-control" cols="50"
                        rows="20"><?=$rs_klinik[0]->tentang?></textarea>
                </div>
                <div class="form-group">
