...
<h6 class="title float-right btn-sm btn-primary" onclick="window.location='<?=base_url('C_setup_artikel/create_web')?>'"><i class="fas fa-plus"></i>&nbsp Tambah</h6>
                ...
                ?>
                    <tr>
                        ...
                        <button
                            ...
                            <button onclick="window.location='<?=base_url('C_setup_artikel/edit_web/').$artikel->id_artikel?>'"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="window.location='<?=base_url('C_setup_artikel/delete_web/').$artikel->id_artikel?>'">Hapus</button>
      </div>
    </div>
  </div>
</div>
