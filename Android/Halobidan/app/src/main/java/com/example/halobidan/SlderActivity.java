...
public class SlderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slder);
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(SlderActivity.this, MainActivity.class));
        finish();
    }
